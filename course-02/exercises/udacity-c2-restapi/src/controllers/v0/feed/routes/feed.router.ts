...
router.patch('/:id', 
    ...
    async (req: Request, res: Response) => {
        ...
        // check either caption or url have been provided
        if (!caption && !fileName) {
            return res.status(400).send({ message: 'One of either caption or file url is required' });
        }
